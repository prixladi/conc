...
struct d_service_info d_service_info_get(const char *proj_name, const char *serv_name);
int d_service_start(const char *proj_name, const struct service_settings service_settings);
int d_service_stop(const char *proj_name, const struct service_settings service_settings);
